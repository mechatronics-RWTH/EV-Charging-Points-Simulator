...
class TypeOfChargingCurve(Enum):
        """
...
class EmpiricPowerMapFactory:
    ...
    def get_power_map_by_type(self, type: Union[TypeOfChargingCurve, None],
        ...
        map=None
        if type is None:
            map=self.get_power_map_random_type(maximum_power=maximum_power,
                                               minimum_power=minimum_power)
        else:
            MapType =self.types.get(type)
            map=MapType(maximum_power=maximum_power,minimum_power=minimum_power)
    ...
    def get_power_map_random_type(self,
        ...
        return map_type(maximum_power=maximum_power,minimum_power=minimum_power)
