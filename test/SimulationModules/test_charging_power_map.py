...
def test_empriric_charging_power_map():
    ...
    random_power_map=fac.get_power_map_by_type(type=None)

    random_power_map.get_maximum_charging_power(0.5).get_in_w()
    random_power_map.get_minimum_charging_power(0.5).get_in_w()
