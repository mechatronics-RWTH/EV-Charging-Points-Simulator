...
def test_initialize_action(rule_based_agent: RuleBasedAgent_One,
                           action_raw_base):
    rule_based_agent.initalize_action(action_raw_base)

    assert rule_based_agent.action == action_raw_base

def test_initialize_once(rule_based_agent: RuleBasedAgent_One, raw_obs):
    rule_based_agent.initialize_once(raw_obs)
...
@pytest.fixture
def initialized_agent(rule_based_agent, raw_obs, action_raw_base):
    rule_based_agent.initalize_action(action_raw_base)
    rule_based_agent.initialize_observation(raw_obs)
...
def test_set_cs_target_power(initialized_agent: RuleBasedAgent_One,
    ...
    initialized_agent.initalize_action(action_raw_base)
...
def test_leave_charging_station_if_charged(initialized_agent: RuleBasedAgent_One,
    ...
    initialized_agent.initialize_once(raw_obs)
